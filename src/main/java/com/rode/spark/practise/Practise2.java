 ...
 * 最后再根据销量做排序
 *
 * 思路：先将键值对转为pairsRDD，然后根据key将结果sum起来再/2
 * @author zhengxinyue
 * @since 2020/10/18
 */
public class Practise2 {
    ...
    private static void practise1(){
        ...
        JavaRDD<Tuple2<String, Integer>> lines = sc.parallelize(Arrays.asList(new Tuple2("spark", 2),new Tuple2("hadoop", 6), new Tuple2("hadoop", 2),
                new Tuple2("spark", 6)));
